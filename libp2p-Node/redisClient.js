...
var redisClient = /** @class */ (function () {
    function redisClient() {
        ...
        this.client.on('connected', function () { return console.log('Redis Client connected'); });
        this.client.on('ready', function () { return _this.ready = true; });
        this.client.on('end', function () { return _this.ready = false; });
        this.init();
    }
    ...
    redisClient.prototype.processQuery = function (msg) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.client.sendCommand(JSON.parse(msg))];
